...
## Enable JavaScript.
## Type: Bool
## If you go to a website that you trust and want to turn on JavaScript, run
## the following command in qutebrowser:
## tsh
## This means toggle scripting for the current host during the current
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'https://search.hbubli.cc'
...
c.url.searchengines = {
    ...
    'gs': 'https://www.github.com/search?q={}',
}

## Page(s) to open at the start.
## Type: List of FuzzyUrl, or FuzzyUrl
c.url.start_pages = ['https://search.hbubli.cc']
